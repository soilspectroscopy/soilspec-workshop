...
> NOTE: linear and spline interpolation do not work outside of the original range. If you have missing data out of the original range, you must use a different approach like imputation to fill the gaps.
...
# NOTE: Dot (.) is used as a placeholder for the previous output of the pipe
# NOTE: We can create quick internal pipes with brackets {}
...
# We can pipe pivot, mutate, and ggplot all together
nir.spectra.rf.int %>%
